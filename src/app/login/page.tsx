    ...
    <div className="min-h-dvh flex items-center justify-center bg-zinc-950 relative overflow-hidden px-4">
      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl overflow-hidden bg-white shadow-xl mb-4">
            <img src="/logo.png" alt="MiBx Logo" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-2xl font-bold text-white">MiBx Dispatch v3</h1>
