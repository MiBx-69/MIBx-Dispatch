...
export default async function DispatchesPage({
  ...
  let query = supabase
    .from("dispatches")
    .select("*, orders(shopify_order_name, customer_name, customer_phone, total_price, line_items)", { count: "exact" })
    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="space-y-2">
        ...
        {dispatches?.map((d: any) => {
          ...
          const trackingUrl = `https://merchant.pathao.com/cn-tracking/${d.consignment_id}`;
